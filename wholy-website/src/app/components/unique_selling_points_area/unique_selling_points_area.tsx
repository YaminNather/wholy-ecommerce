...
import uniqueSellingPointsImage0 from "./assets/0.png";
import uniqueSellingPointsImage1 from "./assets/1.png";
import uniqueSellingPointsImage2 from "./assets/2.png";
import uniqueSellingPointsImage3 from "./assets/3.png";
import greenBoxImage from "./assets/green-box.png";

import darkThemeCrossIconImage from "./assets/yellow-cross-icon.png";
import lightThemeCrossIconImage from "./assets/black-cross-icon.png";
