...
import datesBowlImage from "./assets/dates-bowl.png";

import peanutsImage from "./assets/peanuts.png";
import almondsImage from "./assets/almonds.png";

import curveImage from "./assets/curve-behind-cookie.png";
...
export function IngredientsSection({ productId, uiProduct }: IngredientsSectionProps) {
    return (
        <section className={classNames(styles.ingredients_section)}>
            <Image src={productToTexturedBackgroundMap.get(productId)!} alt="" className={"background_image"} />
            ...
            <div className={classNames("container", styles.container)}>
                ...
                <div className={styles.right_cell}>
                    ...
                    <div className={styles.cookie_container}>
                        <Image src={uiProduct.unwrappedCookieWithHaloImage} alt="" className={styles.cookie} />


                        <Image src={uiProduct.fruits[0]} alt="" className={classNames(styles.fruit, styles.fruit_0)} />
                        
                        <Image src={uiProduct.fruits[0]} alt="" className={classNames(styles.fruit, styles.fruit_1)} />
                        
                        <Image src={uiProduct.fruits[0]} alt="" className={classNames(styles.fruit, styles.fruit_2)} />
                        
                        <Image src={uiProduct.fruits[0]} alt="" className={classNames(styles.fruit, styles.fruit_3)} />
                    </div>

                    <div className={styles.get_energy_reboost_area}>
                        <p>Energy Reboost</p>
                        
                        {/* <button className={("Strawberry" !== "Pineapple") ? "button_yellow" : undefined}> */}
                        <button onClick={() => window.scrollTo({top: 0})} className="button_yellow">
                            GET YOURS
                        </button>
                    </div>
                </div>
