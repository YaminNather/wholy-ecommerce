    ...
    return ( 
        <div style={props.style} className={classNames(styles.order_list_item, props.className)}>
            <div className={styles.top_area}>
                <p className={styles.order_id}>ORDER ID: order_id</p>
            </div>

            <ul className={styles.order_items_list_container}>
                {new Array<number>(3).fill(0).map(
                    (value, index, array) => {
                        return (
                            <li key={index}>
                                <ListItem className={styles.order_item_list_item}>
                                    <Leading>
                                        <div className={styles.product_image_container}>
                                            <Image src={UIProducts.strawberry.wrappedCookieImage} width={240} height={128} alt="" className={classNames(styles.product_image)} />
                                        </div>
                                    </Leading>

                                    <Main>
                                        <p className={styles.title}>2 x Strawberry Cookie</p>
